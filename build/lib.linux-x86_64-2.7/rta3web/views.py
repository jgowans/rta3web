    ...
    def recv_connect(self):
        ...
        def sendcpu():
            ...
            while True:
                ...
                maxy = spectrum.max()
                # freqs = cnf.getFreqs(1)/ 10e6
                data = np.empty((spectrum.size), dtype=spectrum.dtype)
                # data[0::2] = freqs
                # data[1::2] = spectrum
...
def graph_channel_view(request):
    ...
    if 'submit' in request.params:
        ...
        try:
            ...
            spectrum = db.rfi_monitor_get_range(sTimestamp, eTimestamp, channel = channel) #362
        ...
        try:
            ...
            spectrum = db.rfi_monitor_get_range(sTimestamp, eTimestamp, channel = channel)
        ...
        spectrum = db.rfi_monitor_get_range(sTimestamp, eTimestamp, channel = 372)
        overranges = db.rfi_monitor_get_adc_overrange_pos(sTimestamp, eTimestamp)
        frequency = 70.4
