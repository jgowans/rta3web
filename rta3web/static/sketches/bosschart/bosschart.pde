/* @pjs preload="http://kat-sdp-vc3:6543/static/sketches/Images/close.jpg", "http://kat-sdp-vc3:6543/static/sketches/Images/help.jpg", "http://kat-sdp-vc3:6543/static/sketches/Images/refresh.jpg", "http://kat-sdp-vc3:6543/static/sketches/Images/download.jpg"; */
...
void setup(){
    ...
    close = loadImage("http://kat-sdp-vc3:6543/static/sketches/Images/close.jpg");
    refresh = loadImage("http://kat-sdp-vc3:6543/static/sketches/Images/refresh.jpg");
    download = loadImage("http://kat-sdp-vc3:6543/static/sketches/Images/download.jpg");
    help = loadImage("http://kat-sdp-vc3:6543/static/sketches/Images/help.jpg");
}
...
void drawClosestToMouse(){
  ...
  text("(" + formatFloat(x_vals[mouseP], 2)  + ", " + formatFloat(y_vals[mouseP], 2) + ")", XPAN + x_norm[mouseP] + 11, YPAN + y_norm[mouseP]);
